...
def LambdaG(Vinf,V_climb,lambdaig,Omega,R,alpha_tpp):
    """
    ...
    Returns:
        lambda_g
    """
    return (lambdaig + V_climb  + Vinf*np.sin(alpha_tpp)/(Omega*R))


def lambda_i_forward(mu, r, R, sigh,alpha_TPP,Omega,rho,Vinf,V_climb):
    """
    ...
    lambda_G = LambdaG(Vinf,V_climb,lambdaig,Omega,R,alpha_TPP)
